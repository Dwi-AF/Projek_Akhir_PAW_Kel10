...
if( isset($_POST['submit']) ){
        ...
        if ($rows != 0) {
            ...
            if(password_verify($password, $hash)){
             ...
             $error =  'Terjadi error, silakan coba lagi';
        }
    ...
    if( isset($_POST['anon']) ){
        ...
        $query      = "SELECT * FROM users WHERE user_name = 'anon'";
        $result     = mysqli_query($con, $query);
        $rows       = mysqli_num_rows($result);
 

        $hash   = mysqli_fetch_assoc($result)['anonpass'];
        $_SESSION['user_name'] = 'anon';
        ...
        <section class="container-fluid mb-4">
            ...
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="login.php" method="POST">
                    ...
                    <button type="anon" name="anon" class="btn btn-primary btn-block">Sign In Anonim</button>
